...
class Jugador1 (object) :
    ...
    def __init__ (self, joc, img) :
        ...
        self.posicio1 = img.a16
        self.f_kame1 = img.kame
        """ carregà de la imatge inicial del jugador1 i el seu projectil"""
        ...
        self.guerrer1 = pygame.image.load(self.posicio1).convert_alpha()
        self.guerrer1 = pygame.transform.scale(self.guerrer1, (int(self.amplada_jugador), int(self.alsada_jugador)))
        self.kame1 = pygame.image.load(self.f_kame1).convert_alpha()
        self.kame1 = pygame.transform.scale(self.kame1, (int(self.amplada_kame), int(self.alsada_kame)))        
        self.canvi_pos1 = 50
        self.life1 = 3
        self.score1 = 0
        """ posicions del jugador i projectil en la pantalla """
    def actualJuga (self, joc, img) :
        """
...
class Jugador2 (object) :
    ...
    def __init__ (self, joc, img) :
        ...
        self.tret2_speed = 0
        self.acabat2 = False
        self.posicio2 = img.goku
        self.f_kame2 = img.kame
        self.amplada_jugador = joc.amplada_Pantalla/6
        self.alsada_jugador = joc.alsada_Pantalla/3
        """ mides dels jugadors """
        self.amplada_kame = joc.amplada_Pantalla/26
        ...
        self.canvi_pos2 = 50
        self.guerrer2 = pygame.image.load(self.posicio2).convert_alpha()
        self.guerrer2 = pygame.transform.scale(self.guerrer2, (int(self.amplada_jugador), int(self.alsada_jugador)))
        self.kame2 = pygame.image.load(self.f_kame2).convert_alpha()
        self.kame2 = pygame.transform.scale(self.kame2, (int(self.amplada_kame), int(self.alsada_kame)))       
        """ posicions del jugador i projectil en la pantalla """     
        self.life2 = 3
        self.score2 = 0
    ...
    def actualJuga (self, joc, img) :
        ...
        self.guerrer2 = pygame.image.load(self.posicio2).convert_alpha()
        self.guerrer2 = pygame.transform.scale(self.guerrer2, (int(self.amplada_jugador), int(self.alsada_jugador)))
        self.kame2 = pygame.image.load(self.kame2).convert_alpha()
        self.kame2 = pygame.transform.scale(self.kame2, (int(self.amplada_kame), int(self.alsada_kame))) 
...
class Bolesdrac (object) :
    ...
    def __init__ (self, joc, img) :
        ...
        self.ball_y = 0
        self.ballD = pygame.image.load(self.ball).convert_alpha()
        self.ballD = pygame.transform.scale(self.ballD, (int(self.amplada_ball), int(self.alsada_ball)))   
    def actualBole (self, joc, img) :
        """
...
class Joc (object) :
    ...
    def game_over (self,juga1, juga2, joc, img) :
        ...
        """
        self.background = pygame.image.load(img.Fons_n1).convert_alpha()
        self.background = pygame.transform.scale(self.background, (joc.amplada_Pantalla, joc.alsada_Pantalla))
        ...
        joc.pantalla.blit(self.background, (0, 0))
...
#   ---------------------------------------------------------------------------------------------------- 
    ...
    def logicaExecutar (self, juga1, juga2, joc, img, bolesD) :
        ...
        juga1.kame1_rect = juga1.kame1.get_rect()
        ...
        if (juga1.score1+juga2.score2) > 19 and (juga1.score1+juga2.score2 < 30)  :
            ...
            if joc.entrab1 == False :
                bolesD.ballD = pygame.image.load(img.ball4).convert_alpha()
                bolesD.ballD = pygame.transform.scale(bolesD.ballD, (int(bolesD.amplada_ball), int(bolesD.alsada_ball)))
                joc.entrab1 = True
        ...
        if (juga1.score1+juga2.score2) > 49 and (juga1.score1+juga2.score2 < 60)  :
            ...
            if joc.entrab2 == False :
                bolesD.ballD = pygame.image.load(img.ballZ).convert_alpha()
                bolesD.ballD = pygame.transform.scale(bolesD.ballD, (int(bolesD.amplada_ball), int(bolesD.alsada_ball)))
                joc.entrab2 = True
    ...
    def visualPantalla (self, juga1, juga2, joc, img, bolesD) :
        ...
        if juga1.acabat1 == False :
            if joc.ent1 == False :
                self.guerrer1 = pygame.image.load(juga1.posicio1).convert_alpha()
                self.guerrer1 = pygame.transform.scale(self.guerrer1, (int(juga1.amplada_jugador), int(juga1.alsada_jugador)))
                joc.ent1 = False
            joc.pantalla.blit(self.guerrer1, (juga1.j1_x, juga1.j1_y))
            joc.pantalla.blit(juga1.kame1, (juga1.ka1_x, juga1.ka1_y))
        if juga2.acabat2 == False :
            if joc.ent2 == False :
                self.guerrer2 = pygame.image.load(juga2.posicio2).convert_alpha()
                self.guerrer2 = pygame.transform.scale(self.guerrer2, (int(juga2.amplada_jugador), int(juga2.alsada_jugador)))
                joc.ent2 = False
            joc.pantalla.blit(self.guerrer2, (juga2.j2_x, juga2.j2_y))
            joc.pantalla.blit(juga2.kame2, (juga2.ka2_x, juga2.ka2_y))
        joc.pantalla.blit(bolesD.ballD, (bolesD.ball_x, bolesD.ball_y))
        pygame.display.flip()
...
#   --------------------------------------------------------------------------------------------------------------------- 
    ...
    def visualRank (self, joc, container, img) :
        ...
        self.background = pygame.image.load(img.goku8).convert_alpha()
        self.background = pygame.transform.scale(self.background,(int(joc.amplada_Pantalla/2), int(joc.alsada_Pantalla/2)))
        ...
        joc.pantalla.blit(self.background, (int(joc.amplada_Pantalla/2), int(joc.alsada_Pantalla/2)))
...
#   --------------------------------------------------------------------------------------------------------------------- 
        ...
        for event in pygame.event.get() :
            if event.type == pygame.QUIT :
                ...
                if event.key == 282 :
                    ...
                    joc.modiMides()
                    juga1.actualJuga(joc, img)
                    juga2.actualJuga(joc, img)
                    bolesD.actualBole(joc, img)
                if event.key == 283 :
    ...
    def visualMenu (self, txt, joc, img) :
        ...
        """
        joc.pantalla.fill(joc.color_scr)
        self.background = pygame.image.load(img.goku2).convert_alpha()
        self.background = pygame.transform.scale(self.background,(joc.amplada_Pantalla, joc.alsada_Pantalla))
        self.tipografia = pygame.font.SysFont("serif", joc.mida_txt)
        ...
        """
        joc.pantalla.blit(self.background, (0,0))
        """pygame.draw.rect(joc.pantalla, txt.color_txt1, [joc.amplada_Pantalla/10, 5, 300, 60],5)"""
        joc.pantalla.blit(self.opcio1, (joc.amplada_Pantalla/10, 10))
        """pygame.draw.rect(joc.pantalla, txt.color_txt2, [joc.amplada_Pantalla/10, joc.alsada_Pantalla*2/10-5 , 430, 60],5)"""        
        joc.pantalla.blit(self.opcio2, (joc.amplada_Pantalla/10, joc.alsada_Pantalla*2/10))
        """pygame.draw.rect(joc.pantalla, txt.color_txt3, [joc.amplada_Pantalla/10, joc.alsada_Pantalla*4/10-5 , 390, 60],5)"""
        joc.pantalla.blit(self.opcio3, (joc.amplada_Pantalla/10, joc.alsada_Pantalla*4/10))
        """pygame.draw.rect(joc.pantalla, txt.color_txt4, [joc.amplada_Pantalla/10, joc.alsada_Pantalla*6/10-5 , 390, 60],5)"""
        joc.pantalla.blit(self.opcio4, (joc.amplada_Pantalla/10, joc.alsada_Pantalla*6/10))
        """pygame.draw.rect(joc.pantalla, txt.color_txt5, [joc.amplada_Pantalla/10, joc.alsada_Pantalla*8/10-5 , 260, 60],5)"""
...
def main():
    ...
    text1 = Text1 ()
    img = carregaImg()
    jugador1 = Jugador1 (joc, img)
    jugador2 = Jugador2 (joc, img)
    bolesD = Bolesdrac (joc, img)
    """
